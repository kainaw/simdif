import pytest
from simdif.metrics.cosine import dist_cosine, sim_cosine, dif_cosine
from simdif import cosine, sim, dif, simdif
...
def test_cosine_basic():
    ...
    assert dif_cosine([-2, -2], [2, 2]) == pytest.approx(1.0)
    assert dif([-2, -2], [2, 2], 'cosine') == pytest.approx(1.0)
